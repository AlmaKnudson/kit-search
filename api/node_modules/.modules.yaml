...
hoistedDependencies:
  ...
  /@jest/core/29.6.2(ts-node@10.0.0):
    '@jest/core': private
  ...
  /@nestjs/mapped-types/2.0.2(@nestjs/common@9.0.0)(reflect-metadata@0.1.13):
  ...
  /jest-circus/29.6.2:
    jest-circus: private
  /jest-cli/29.6.2(@types/node@18.15.11)(ts-node@10.0.0):
    jest-cli: private
  /jest-config/29.6.2(@types/node@18.15.11)(ts-node@10.0.0):
    jest-config: private
  /jest-diff/29.6.2:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Thu, 17 Aug 2023 13:22:53 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/almaknudson/Library/pnpm/store/v3
